...
% Возникает такое чувство, что в Post_Relaxed все дырки в топологии держатся в 2 раза дольше. Бред какой-то.
...
% В среднем каналы на 140 тактов (инкрементов фильтрации Виеториса-Рипса) больше держат дырки в топологии.
...
% То есть графики каналов стали еще меньше похожи друг на друга.
% И что? Я не могу сказать, что это значит.